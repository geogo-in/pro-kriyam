...
function ProjectItem(row) {
  ...
  return (
    <StyledTableRow key={row.name} sx={{ "&:last-child td, &:last-child th": { border: 0 } }}>
      ...
      <TableCell component="th" scope="row" sx={{ "& span": { color: theme => theme.palette.mode === "light" ? theme.palette.primary.defaultText : theme.palette.text.default }, "& :hover": { color: theme => theme.palette.primary.main } }}>
