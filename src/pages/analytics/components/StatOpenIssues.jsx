...
const StatOpenIssues = ({ openIssues }) => {
  ...
  return (
    <Card>
      <CardContent sx={{ px: 3 }}>
        <TextWithPopover text="Open issues" popoverText="Number of issues in different projects, which is not resolved yet." />
        ...
        <TabsUnstyled defaultValue={0}>
          <TabsListUnstyled>
            <StyledTab>
              <TextWithPopover
                showBorder={false}
                text="Workload of members"
                popoverText="This chart shows the number of open issues in different projects and it's allocation to members."
                fontSize="0.75rem"
              />
            </StyledTab>
            <StyledTab>
              <TextWithPopover showBorder={false} text="In different projects" popoverText="This chart shows the number of open issues in different projects" fontSize="0.75rem" />
            </StyledTab>
          </TabsListUnstyled>
