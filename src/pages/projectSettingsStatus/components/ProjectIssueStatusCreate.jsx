...
export default function ProjectIssueStatusCreate({ project_id }) {
  ...
  return (
    <Paper component="form" onSubmit={handleSubmit} sx={{ p: 2, mb: 1 }}>
      ...
      <Typography variant="h5" sx={{ color: theme => theme.palette.mode === "light" ? theme.palette.primary.defaultText : theme.palette.text.secondary, fontSize: "0.95rem", fontWeight: 500, mb: 1 }}>
