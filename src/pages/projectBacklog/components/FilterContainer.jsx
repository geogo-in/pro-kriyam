...
export default function FilterContainer({ filter, setFilter, project_id }) {
  ...
  return (
    <Stack direction="row" spacing={0.8} sx={{ alignItems: "center", padding: "8px 0" }}>
      <Paper sx={{ boxShadow: "none", background: theme => theme.palette.mode === "light" ? "#f1f5f9" : theme.palette.background.modal, color: theme => theme.palette.mode === "light" ? "#1E293B" : theme.palette.primary.secondaryText, borderRadius: "30px", p: "2px 4px", margin: "8px 0", display: "flex", alignItems: "center", width: 280 }}>
