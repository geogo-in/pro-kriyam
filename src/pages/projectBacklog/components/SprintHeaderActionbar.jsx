        ...
        <Stack direction="row">
          <SimpleDiv sx={{ width: `calc( ${actionbarWidth}px )` }}>
            <Box sx={{ alignItems: "center", display: "flex", marginTop: "0px", marginBottom: 1 }}>
              ...
              <Typography variant="body2" sx={{ padding: "0 10px", color: theme => theme.palette.mode === "light" ? "#54637c" : theme.palette.primary.secondaryText, flexGrow: 1 }}>
              ...
              {project?.project_type?.id === 1 && sprint_id !== "backlog" && (
                <>
                  ...
                  <IconButton size="small" onClick={handleSprintOption} sx={{ background: theme => theme.palette.mode === "light" ? "#f1f5f9" : theme.palette.background.modal, ml: 1, mr: 1, p: 0.8 }}>
                    <MoreHorizIcon />
                  </IconButton>
